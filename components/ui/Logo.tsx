...
export default function Logo({ className = "w-10 h-10" }: LogoProps) {
  return (
    ...
    >
      <circle cx="42" cy="42" r="36" stroke="#2E9BE8" strokeWidth="7" fill="white" />
      <g transform="translate(42,42)">
        {[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330].map((deg, i) => (
          <path
            key={deg}
            d="M0,-26 L3.5,-13 L-3.5,-13 Z"
            fill={["#2E9BE8", "white", "#E63946"][i % 3]}
            transform={`rotate(${deg})`}
          />
        ))}
        <circle r="11" fill="#FFC833" />
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <line x1="68" y1="68" x2="88" y2="88" stroke="#E63946" strokeWidth="8.5" strokeLinecap="round" />
    </svg>
  );
}
