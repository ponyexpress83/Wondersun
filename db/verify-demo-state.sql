...
-- Atteso: legacy=0, vetrina=0, montauto_ok=1, montauto_experiences=4, prosecdef=true.
-- ─────────────────────────────────────────────────────────────────────────
...
-- 4) ESATTAMENTE 1 Tenuta Montauto con gli attributi giusti
...
where business_name = 'Tenuta Montauto'
  ...
  and contact_phone = '+393793785317';
...
-- 7) Sanity: la prenotazione demo NON deve essere toccata (deve restare 'richiesta')
