...
insert into public.experiences (
  ...
  ((select id from s), 'navigazione-tramonto', 'Navigazione al Tramonto',
   ...
   'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200&q=80', 'pubblicata'),
  ((select id from s), 'equitazione-maremma', 'Equitazione nella Maremma',
   ...
   'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=1200&q=80', 'pubblicata'),
  ((select id from s), 'cena-chef-locale', 'Cena con Chef Locale',
   ...
   'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80', 'pubblicata'),
  ((select id from s), 'degustazione-vini-doc', 'Degustazione Vini DOC Maremma',
   ...
   'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=1200&q=80', 'pubblicata'),
  ((select id from s), 'ebike-borghi-etruschi', 'E-Bike tra i Borghi Etruschi',
   ...
   'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&q=80', 'pubblicata'),
  ((select id from s), 'necropoli-sorano', 'Necropoli Etrusche di Sorano',
   ...
   'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=1200&q=80', 'pubblicata')
